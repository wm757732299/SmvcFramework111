(function(a) {
	a.fn.nthTabs = function(c) {
		...
		var e = a.extend({}, g, c);
		var d = '<div class="page-tabs"><a href="#" class="roll-nav roll-nav-left"><span class="fa fa-backward"></span></a><div class="content-tabs"><div class="content-tabs-container"><ul class="nav nav-tabs"></ul></div></div><a href="#" class="roll-nav roll-nav-right"><span class="fa fa-forward"></span></a><div class="dropdown roll-nav right-nav-list"><a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><span class="fa fa-chevron-down"></span></a><ul class="dropdown-menu" style="left: -142px;"><li><a href="#" class="tab-location">\u5b9a\u4f4d\u5f53\u524d\u9009\u9879\u5361</a></li><li><a href="#" class="tab-close-current">\u5173\u95ed\u5f53\u524d\u9009\u9879\u5361</a></li><li role="separator" class="divider"></li><li><a href="#" class="tab-close-other">\u5173\u95ed\u5176\u4ed6\u9009\u9879\u5361</a></li><li><a href="#" class="tab-close-all">\u5173\u95ed\u5168\u90e8\u9009\u9879\u5361</a></li><li role="separator" class="divider"></li><li class="scrollbar-outer tab-list-scrollbar"><div class="tab-list-container"><ul class="tab-list"></ul></div></li></ul></div></div><div class="tab-content" style="padding:10px;background-color: #fff;height: 95%;"></div>';
		var b = {
			init : function() {
				h.html(d);
				b.listen()
			...
			addTab : function(j) {
				...
				m = m ? "active" : "";
				i ? k.push('<li role="presentation" class="' + m + '">'): k.push('<li role="presentation" class="' + m + '" name="' + j.id + '">');
				...
				var l = [];
				l.push('<div class="tab-pane ' + m + '" id="' + j.id + '" style="height: 100%;" >');
				l.push("<iframe  width='100%' height='100%' style='overflow-y: hidden;border: none;'  src='"+basePath+j.content+"' data-menuid='"+j.id+"'></iframe>");//http://localhost:8080/SmvcFramework/demo/home_index.wmctl
				l.push("</div>");
			...
			delOtherTab : function() {
				h.find(".nav-tabs li").not('[class="active"]').not('[name="ONE-LEVEL-HOME-PAGE"]').remove();
				h.find(".tab-content div").not('[class="tab-pane active"]').not('[id="ONE-LEVEL-HOME-PAGE"]')
						.remove();
				return b
			},
			delAllTab : function() {
				h.find(".nav-tabs li").not('[name="ONE-LEVEL-HOME-PAGE"]').remove();
				h.find(".tab-content div").not('[id="ONE-LEVEL-HOME-PAGE"]').remove();
				h.find('[name="ONE-LEVEL-HOME-PAGE"]').addClass("active");
				h.find('[id="ONE-LEVEL-HOME-PAGE"]').addClass("active");
				return b
			},
