	...
	a.fn.nthTabs = function(c) {
		...
		var b = {
			...
			addTab : function(j) {
				...
				l.push("<iframe  width='100%' height='100%' style='overflow-y: hidden;border: none;'  src='"+basePath+j.content+"'></iframe>");//http://localhost:8080/SmvcFramework/demo/home_index.wmctl
				l.push("</div>");
