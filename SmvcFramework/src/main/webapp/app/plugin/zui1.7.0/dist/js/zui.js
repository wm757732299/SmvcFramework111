        ...
        data.forEach(function (e) {
            if (e.children && e.children.length > 0) {
                ...
                e.children.forEach(function (child) {
                    menucontent += '<li class="'+(child.active!=undefined && child.active===true?'active':'' )+'"><a href="javascript:menuListener.addTab(\''+child.id+'\',\'' + child.url+'\',\'' +child.text+ '\')"  ><i class="' + child.icon + '"></i> ' + child.text + '</a></li>';
                })
                menucontent += '</ul></li>';
            } else
                menucontent += '<li class="'+(e.active!=undefined && e.active===true?'active':'' )+'"><a href="javascript:menuListener.addTab(\''+e.id+'\',\'' + e.url+'\',\'' +e.text+ '\')"><i class="' + e.icon + '"></i> ' + e.text + '</a></li>';
        });
        menucontent += '</ul> </nav>';
